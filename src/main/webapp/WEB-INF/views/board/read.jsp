...
<form role="form">
  ...
  <!-- 제목  -->
   <div class="form-group">
    ...
    <input type="text" value="${boardVO.title}" class="form-control" id="title" name="title" readonly>
  </div>
  <!-- 작성자  -->
  <div class="form-group">
    <label for="formGroupExampleInput">WRITER</label>
    <input type="text" value="${boardVO.writer}" class="form-control" id="writer" name="writer"readonly>
  </div>
  <!-- 내용  -->
  <div class="form-group">
